#!/usr/bin/env bash
# Runs the AFTER hierarchy recon SQL on dev2 using sqlplus.
# Usage:
#   ./run_recon_after.sh /abspnshare/migration/brm/landing_dir/master.config 02_after_hierarchy.sql
...
SQL_FILE="${2:-02_after_hierarchy.sql}"
...
echo "==> Running AFTER recon: $SQL_FILE"
